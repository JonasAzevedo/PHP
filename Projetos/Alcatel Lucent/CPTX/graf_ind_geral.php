...
$cores = array('black','blue','orange','green','yellow','purple','yellow','#028456','#028456','#028456');
...
for($x=1;$x<cal_days_in_month(CAL_GREGORIAN, $mes, $ano)+1;$x++) {
	...
	$query2 = mysql_query("SELECT COUNT(`circuito`) FROM `tabelacptx` WHERE `data_e` = '$ano-$mes-$dia' and `tr` = '$terror'");
