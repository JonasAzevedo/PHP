...
$activity = new GanttBar(0,"Project","2010-01-01","2010-02-10");
...
// ($row,$title,$startdate,$enddate)
$activity2 = new GanttBar(1,"Project","2010-01-01","2010-12-10");
...
// Create a miletone
$milestone = new MileStone(2,"Milestone","2002-01-15","2001-01-15");
