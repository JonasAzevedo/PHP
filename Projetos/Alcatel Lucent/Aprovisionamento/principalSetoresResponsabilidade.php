<?php
  /* tela principal de Setores Responsáveis
...
?>
  ...
  <head>
    ...
    <title>Setores Responsáveis</title>
    </head>
      <body>
        <center>
          <p>
          ...
          <p>
            ...
            <a href="cadSetorResponsabilidade.php?opcao=consulta">Cadastrar Setor Responsável</a>
          </p>
          <h2>Setor Responsável</h2>
        </center>
        <p></p>
                  ...
                  <div id="boxes">
                    ...
                    <div style="border-bottom:#999999 solid 1px; margin-top:5px;"></div>
                      <br/>
                        <?php
                          echo "<fieldset>";
                          echo "<legend>&nbsp;&nbsp;Setores Responsáveis's&nbsp;&nbsp;</legend>";
                          echo "<b>";
                          echo "<p>";
